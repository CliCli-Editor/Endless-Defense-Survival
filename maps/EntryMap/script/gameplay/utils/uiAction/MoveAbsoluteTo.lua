...
local MoveAbsoluteTo = class("MoveAbsoluteTo", ActionBase)

function MoveAbsoluteTo:ctor(ui, fromPos, toPos, duration, onComplete)
    self.fromPos = fromPos
    self.toPos = toPos
    self.duration = duration
    self.onComplete = onComplete
    MoveAbsoluteTo.super.ctor(self, ui)
end

function MoveAbsoluteTo:tick(dt)
