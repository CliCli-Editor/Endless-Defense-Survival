...
y3.game:event('选中-单位', function (trg, data)
    ...
    y3.gameApp:dispatchEvent(y3.EventConst.EVENT_SURVIVE_SELECT_UNIT,data.player,true)
end)
...
y3.game:event('选中-取消', function (trg, data)
    ...
    data.player._selecting_group = nil
    y3.gameApp:dispatchEvent(y3.EventConst.EVENT_SURVIVE_SELECT_UNIT,data.player,false)
end)
